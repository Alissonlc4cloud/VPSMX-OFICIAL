...
[[ ! -e /usr/bin/trans ]] && wget -O /usr/bin/trans https://raw.githubusercontent.com/DanssBot/VPSMX-OFICIAL/master/NEW-ULTIMATE-VPS-MX-8.0/_%24_Versiones/Generador_Gen_VPS-MX/Install/trans &> /dev/null
